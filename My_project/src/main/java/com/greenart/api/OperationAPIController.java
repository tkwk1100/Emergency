...
public class OperationAPIController {
    ...
    @GetMapping("/api/Operation")//중증질환자 수용가능정보 조회 
    ...
    public Map<String, Object> getOperationRegion(@PathVariable String o_region, @RequestParam String keyword) {
        ...
        List<OperationVO> list = service.selectOperation(o_region, keyword);
    ...
    public Map<String, Object> getHOcnt(){
        ...
        List<OperationVO> HOcnt_list = service.selectCntOperation();
        resultMap.put("HOcnt",HOcnt_list);
        return resultMap;
    }
}
